...
def main_query(query):
    ...
    chunks = generate_semantic_chunk(documents, chunk_size=256,chunk_overlap=50)
...
#streamlit run /Users/carloszurita/Documents/czurita_fork/Castro_Cofre_Zurita/main_app_v2_hybrid.py