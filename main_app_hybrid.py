...
from src.vector_store_client.qdrant_hy import create_qdrant_vector_store_hy
...
def main():
    ...
    with SuppressOutput():
        vector_store = create_qdrant_vector_store_hy(chunks, embedding_model)

    # Consultar la base vectorial
    query = "O que fala acerca do rotulagem?"
