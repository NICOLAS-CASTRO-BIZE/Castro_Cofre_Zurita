...
def create_qdrant_vector_store_hy(docs: list, embedding_model, vector_size: int = 384, collection_name: str = "demo_collection", path: str = "/tmp/langchain_qdrant") -> QdrantVectorStore:
    """
